...
export declare class AuthService {
    ...
    private jwtService;
    private roleService;
    constructor(usersService: UserService, jwtService: JwtService, roleService: RoleService);
    validateUser(email: string, pass: string): Promise<any>;
    getHashPassword: (password: string) => string;
    login(userinf: UserLoginDto, response: Response): Promise<{
        access_token: string;
        user: import("../user/user.schema").UserDocument;
    } | null>;
    register(User: CreateUserDto): Promise<import("mongoose").Document<unknown, {}, import("../user/user.schema").UserDocument> & import("../user/user.schema").User & import("mongoose").Document<any, any, any> & {
